    ...
    return (
        <div className="mt-10">
            ...
            <div className="flex items-center mt-5 h-[54px]  rounded-lg  bg-[#fdf2e3]">
                <Button icon={<AiOutlinePlus size={27} color="#bf7412" />} onClick={increment} className="h-full !bg-transparent  flex-1 flex justify-center items-center"/>
                ...
                <Button icon={ <AiOutlineMinus size={27} color="#bf7412" />} onClick={decrement} className="h-full !bg-transparent flex-1 flex justify-center items-center"/>
