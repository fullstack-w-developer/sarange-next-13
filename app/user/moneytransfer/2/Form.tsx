...
const Form = ({ details }: Props) => {
    ...
    return (
        ...
        <motion.div 
        variants={variants}
        className="w-90 flex flex-col justify-between min-h-screen">
            <div className="flex flex-col ">
                <BackHeader url="/user/moneytransfer/1" name="انتقال وجه"/>
                <CardInfo details={details} />

                <div className="flex flex-col gap-3 mt-14">
                    <p className="font-artin-bold text-xl text-[#222]">برای تائید انتقال وجه لطفا رمز عبور خود را وارد کنید</p>
