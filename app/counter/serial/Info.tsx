...
const Info = () => {
    return (
        <div className="mb-10">
            <h1 className="font-artin-black text-xl">شارژ کارت از طریق شماره سریال</h1>
            <nav className="mt-5">
                <p className="font-artin-regular text-[#626262]">به هنگام شارژ با شماره سریال کارت، لطفا به موراد زیر دقت کنید</p>
                <ul className="flex flex-col gap-2 mt-3">
                    ...
                    <li className="flex items-start  gap-3">
                        ...
                        <p className="font-artin-regular">
                            سپس برای تائید پرداخت بالای یک نفر باید رمز عبور کاربر را وارد نمایید
                        </p>
                    </li>
                    <li className="flex items-start  gap-3">
                        <span className="block w-1 h-1 mt-3 bg-gray-800 rounded-full"></span>
