        ...
        <div className='mt-16 flex flex-col-reverse gap-10 md:flex-row items-center justify-between'>
            <div className='flex-1 text-[#000000] text-[14px]'>
                <div className='space-y-3'>
                    ...
                    <p className='text-justify font-estedad-medium text-[14px]'>اپلیکیشن سارنگ یک برنامه ای کاربردی و چندمنظوره است که با استفاده از آن بر روی گوشی خود میتوانید برخی از کارهای روزمره خودتان را به سادگی از طریق آن انجام دهید.
                    </p>
                    <p className='font-estedad-medium text-[14px]'>برخی امکانات مهم اپلیکیشن:</p>
